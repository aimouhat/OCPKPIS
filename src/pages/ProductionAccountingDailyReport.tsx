...
import ProductionAccountingWidget from "../components/widgets/ProductionAccounting";
    ...
    return (
        <VStack spacing={6} align="stretch" p={6}>
            <Box display="flex" alignItems="center">
                ...
                <Heading ml={6}>Production Loss Accounting</Heading>
            </Box>
                ...
                <Box width={1500}>
                    <VStack spacing={6} align="stretch" p={6}>
                        <GridItem colSpan={{ base:30, lg:20}}>
                            <ProductionAccountingWidget 
                                widgetName="Production Accounting"
                                initialReason = 'OD'
                                // Replace these with your actual database tag names
                                productionRateTag="PlantA_CV_OUT_ProductionRate"
                                priceTag="PlantA_ID_ConcentratePrice"
                                
                                // Optional: Override the default 7-day window
                                // initialStartTime="2023-10-01"
                                // initialEndTime="2023-10-08"
                            /> 
                        </GridItem>
